...
public class VirusTestBackup {public static void main(String[] args) {
    InfectionTime[] virus = new InfectionTime[50];
    ArrayList<InfectionTime> correctVirus;
    correctVirus = new ArrayList<InfectionTime>();
        ...
        try {
            ...
            if (
                    nameMatcher.matches()
                            ...
                            && dateMatcher.matches()
                            && hourMatcher.matches()
                            && minuteMatcher.matches()
                            && secondMatcher.matches()
                            && yearMatcher.matches()
                            && timezoneMatcher.matches()
            )
    ...
    InfectionTimeStorage2.writeInfectionTime(correctVirus);
    System.out.println(InfectionTimeStorage2.readInfectionTime());
