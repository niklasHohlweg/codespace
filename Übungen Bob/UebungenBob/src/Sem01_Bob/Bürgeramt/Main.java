    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            if(befehl.equals("add")){
                ...
                System.out.println(name + " betritt das Sem01_Bob.Bürgeramt. Grund: " + anliegen);
            ...
            if(befehl.equals("process")){
                ...
                System.out.println("Das Anliegen " + anliegen + " von " + name + " wurde bearbeitet, Er/Sie verässt das Sem01_Bob.Bürgeramt.");
